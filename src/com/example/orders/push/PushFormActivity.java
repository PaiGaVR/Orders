...
import com.example.order.push.timeWheel.StrericWheelAdapter;
import com.example.order.push.timeWheel.WheelView;
	...
	protected void onCreate(Bundle savedInstanceState) {
	  ...
	  public void initContent()
	    ...
	    public void buttonClick(View v)
	    {
	    	...
	    	if(id==R.id.pick_bt)
	    	{
	    		View view = ((LayoutInflater)getSystemService(LAYOUT_INFLATER_SERVICE)).inflate(R.layout.push_time_picker, null); 
