...
public class ViewPagerActivity extends Activity implements OnClickListener,
	...
	// 引导图片资源
	private static final int[] pics = { R.drawable.img_frame_background,
			R.drawable.img_frame_background, R.drawable.img_frame_background,
			R.drawable.img_frame_background };
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		button.setOnClickListener(new ExperienceButton());
		// 初始化底部小点
		initDots();
	}

	class ExperienceButton implements OnClickListener {
		@Override
