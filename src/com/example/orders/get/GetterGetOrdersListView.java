...
public class GetterGetOrdersListView extends ListView {
	...
	public GetterGetOrdersListView(Context context) {
		this(context, null);
	}

	public GetterGetOrdersListView(Context context, AttributeSet attrs) {
	...
	/**
	 * 返回true,交付列表视图。返回false,交给孩子。如果动,返回真
	 * 
	 */
	@Override
	...
	/**
	 * show or hide right layout animation显示或隐藏正确布局动画
	 */
