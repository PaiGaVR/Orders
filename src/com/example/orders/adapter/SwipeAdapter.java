...
public class SwipeAdapter extends BaseAdapter {
     ...
     * @param mainActivity
     */
    public SwipeAdapter(Context ctx,List<PushOrders> data, int rightWidth) {
        mContext = ctx;
        this.data = data;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        ViewHolder holder;
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.push_orders_list_item, parent, false);
        ...
        PushOrders msg = data.get(position);
