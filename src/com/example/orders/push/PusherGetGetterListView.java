...
public class PusherGetGetterListView extends ListView {
	...
	public PusherGetGetterListView(Context context) {
		this(context, null);
	}

	public PusherGetGetterListView(Context context, AttributeSet attrs) {
